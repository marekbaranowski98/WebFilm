    ...
    const menuName: {id: number, title: string, children: {id: number, element: string}[]}[] = [
        ...
        { id: 3, title: "Ranking filmów", children: [], },
        {
            ...
            children: [
                ...
                { id: 2, element: "Zarządzaj słowami kluczowymi", },
            ],
        },
        {
            id: 5,
            ...
            children: [
                ...
                { id: 2, element: "Dodaj słowo kluczowe", },
            ],
        },
    ];
                ...
                <div className="menu-banner">
                    <nav>
                        <div className="menu-content">
                            ...
                            <ul>
                                {menuName.map(x => <li key={x.id}><MenuHeader headerTitle={x.title}
                                                                   subMenuChildren={x.children} /></li>)}
                            </ul>
                        </div>
                    </nav>
                </div>
